...
def main():
    ...
    parser.add_argument('--oracle_exp_path', default=None, type=str)
    ...
    if args.rand_aug:
        CFG.exp_name=f"focal_lovasz_adam_rand_aug_{args.aug_type}"
    elif args.PIL_tfms!=None:
        CFG.exp_name=f"focal_lovasz_adam_{args.aug_type}_{''.join(args.PIL_tfms)}"
    elif args.mixup!=None:
        CFG.exp_name=f"ocal_lovasz_adam_{args.aug_type}_mixup{args.mixup}"
    else:
        CFG.exp_name=f"focal_lovasz_adam_{args.aug_type}_{args.fcm_mask}"
    CFG.results_dir=f"oracle_results/{CFG.exp_name}_frontview/"
    CFG.job_type=f"oracle_{args.aug_type}"
    CFG.fold=args.folds
    ...
    print(args.rand_aug, CFG.rand_aug)
